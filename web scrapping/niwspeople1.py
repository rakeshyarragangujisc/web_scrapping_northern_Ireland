...
topics_df = pd.read_csv("topics_list1.csv")
...
detailed_df.to_csv("people_detailed_metadata.csv", index=False)

print("Detailed metadata saved to people_detailed_metadata.csv")
